...
print("arr (shape %s) = "% str(arr.shape))
print(arr)
# arr2 = np.array([[[2,2], [3,5]]]) #will not work. They do not agree
# arr2 = np.array([[[[2][2]], [[3],[5]]]]) #will work
arr2 = np.arange(2*1*2*1).reshape(2,1,2,1)
print("arr2 (shape %s) = "% str(arr2.shape))
# print("arr2 = ")
print(arr2)
print("arr2 broadcasted to arr (shape = %s)=" % str((arr2+np.zeroes(arr.shape)).shape))
print(arr2+np.zeros(arr.shape))
print("arr broadcasted to arr2 (shape = %s)=" % str((arr+np.zeroes(arr2.shape)).shape))
print("arr + arr2 =")
print(arr+arr2)
